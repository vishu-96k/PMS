...
all_results_df = pd.DataFrame(columns=['date', 'time', 'state', 'number'])
    ...
    for (x, y, w, h) in plates:
        ...
        if area > min_area:
            ...
            if result:
                ...
                all_results_df = all_results_df.append(result_data, ignore_index=True)

                # Write the DataFrame to the Excel file
                all_results_df.to_excel('NUMBER_PLATE.xlsx', index=False)
